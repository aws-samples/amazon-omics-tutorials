...
This is a point in time copy of the [NF-Core / rnaseq workflow at version 3.11.1](https://nf-co.re/rnaseq/3.11.1) that has been modified to run on [AWS HealthOmics](https://aws.amazon.com/omics/) and can be used to create a Private Workflow with AWS HealthOmics. More details of how this workflow was modified from its upstream source can be found in the [AWS-HEALTHOMICS.md](./AWS-HEALTHOMICS.md) file.
