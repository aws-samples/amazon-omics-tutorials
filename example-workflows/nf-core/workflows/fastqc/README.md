...
3. Download the pipeline and test it on a minimal dataset with a single command:
   ...
   ```bash
   nextflow run omicsqc/omicsqc -profile test,YOURPROFILE --outdir <OUTDIR>
   ```
...
4. Start running your own analysis!
   ...
   ```bash
   nextflow run omicsqc/omicsqc --input samplesheet.csv --outdir <OUTDIR> --genome GRCh37 -profile <docker/singularity/podman/shifter/charliecloud/conda/institute>
   ```

## Credits

omicsqc/omicsqc was originally written by Fernando Izquierdo.
...
<!-- If you use  omicsqc/omicsqc for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
