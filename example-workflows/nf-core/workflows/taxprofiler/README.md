...
This is a point in time copy of the [NF-Core / taxprofiler workflow at version 1.0.0](https://nf-co.re/taxprofiler/1.0.0) that has been modified to run on [AWS HealthOmics](https://aws.amazon.com/omics/) and can be used to create a Private Workflow with AWS HealthOmics. More details of how this workflow was modified from its upstream source can be found in the [AWS-HEALTHOMICS.md](./AWS-HEALTHOMICS.md) file.
